  ...
  <section class="section-about">
    ...
    <div class="row">
      <div class="col-1-of-2">
        ...
        <p class="paragraph">
          Lorem, ipsum dolor sit amet consectetur adipisicing elit. Nulla, fugiat cupiditate quae qui ad commodi, sequi ratione modi repellat amet, totam cum delectus? Ad ipsum modi.
        </p>

        <h3 class="heading-tertiary u-margin-bottom-small">Live adventures like you never had before</h3>
        <p class="paragraph">
          Lorem ipsum dolor sit amet consectetur adipisicing elit. Sed ab possimus ratione vitae ipsam provident laboriosam corporis quibusdam ea eos?
        </p>
    ...
    <div class="row">
      ...
      <div class="col-1-of-4">
        <div class="feature-box">
          ...
          <h3 class="heading-tertiary u-margin-bottom-small">Live a heathier life</h3>
          <p>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Labore necessitatibus deleniti dolorum!</p>
        </div>
      </div>
    </div>
    ...
    <div class="row">
      <div class="story">
        ...
        <div class="story__text">
          ...
          <p>
            Lorem, ipsum dolor sit amet consectetur adipisicing elit. Nulla, fugiat cupiditate quae qui ad commodi, sequi ratione modi repellat amet, totam cum delectus? Ad ipsum modi.Lorem ipsum dolor sit amet consectetur adipisicing elit. Sed ab possimus ratione vitae ipsam provident laboriosam corporis quibusdam ea eos?
          </p>
        </div>
      </div>
    </div>
  ...
  <div class="row">
    ...
    <div class="col-1-of-2">
      <p class="footer__copyright">
        Built by <a href="" class="footer__link">Jadiel dos Santos</a> for studying reasons. Copyright &copy; by Jonas Schmedtmann. You are all 100% allowed to use this webpage for both personal and commercial use, but NOT claim it as your own design. A credit to the original author, Jonas Schmedtmann, is of course highly appreciated!
      </p>
    </div>
  </div>
</footer>
